...
(function () {
  ...
  function lerUrlFiltros() {
    ...
    ["precoMin","precoMax","comprimentoMin","comprimentoMax","larguraMin","larguraMax","espessuraMin","espessuraMax"].forEach((id) => {
      const el = document.getElementById(id);
      if (el && params.get(id)) el.value = params.get(id);
    });

    // Produto individual: abre o modal
  ...
  function gerarUrlFiltros() {
    ...
    if (ordenarProdutos?.value && ordenarProdutos.value !== "recentes") params.set("ordem", ordenarProdutos.value);
    ["precoMin","precoMax","comprimentoMin","comprimentoMax","larguraMin","larguraMax","espessuraMin","espessuraMax"].forEach((id) => {
      const el = document.getElementById(id);
